...
export default function Home() {
  ...
  return (
    <div className="relative h-screen bg-[#0047AB] flex flex-col overflow-hidden font-sans">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col items-center justify-start px-6 relative z-10 pt-4 pb-8 md:justify-center md:pt-4 md:pb-12">
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-center space-y-0.5 mb-4 mt-2 md:mt-2"
        >
